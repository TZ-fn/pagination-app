function Error({ errorMessage }: { errorMessage: string }) {
  return (
    <div className="max-w-2xl px-6 py-6 mx-auto flex flex-col align-middle justify-center text-lg">
      <svg className=" h-10 w-10 mx-auto my-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 122.88">
        <title>cross</title>
        <path
